...
One important note here, notice that ggplot does NOT use the pipe.  As Hadley says, it was built before the pipe was discovered, so it uses the + sign as it’s linking mechanism.
